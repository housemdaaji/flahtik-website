...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ background: '#f0f6ff' }}>
      ...
      <div className="container" style={{ paddingTop: '96px', paddingBottom: '96px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', border: '1px solid #e2e8f0', marginBottom: '48px', background: '#fff' }}>
          {/* Selectors */}
          <div style={{ background: '#0a1628', display: 'flex', flexDirection: 'column' }}>
            {types.map(t => (
              <button key={t.id} onClick={() => setType(t.id)} style={{
                ...
                borderLeft: type === t.id ? '3px solid #2563eb' : '3px solid transparent',
                transition: 'all 0.2s',
              }}>
                <div>
