    ...
    <section id="platform" style={{ background: '#fff' }}>
      ...
      <div className="container" style={{ paddingTop: '96px', paddingBottom: '96px' }}>
        ...
        <div style={{
          ...
          gap: '48px', alignItems: 'end', marginBottom: '72px',
        }}>
          <div>
            <div style={{
        ...
        {/* Pipeline */}
        <div style={{ borderLeft: '1px solid #e2e8f0', marginLeft: '20px', marginBottom: '64px' }}>
          {steps.map((s, i) => (
            <div key={s.num} style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: '-21px' }}>
                <div style={{
                  ...
                  background: i === steps.length - 1 ? '#06b6d4' : '#2563eb',
                  border: '2px solid #fff',
                  boxShadow: i === steps.length - 1 ? '0 0 0 2px #06b6d4, 0 0 16px rgba(6,182,212,0.4)' : '0 0 0 2px #2563eb',
              ...
              <div>
                <div style={{
                  ...
                  background: i === steps.length - 1 ? '#0a1628' : '#f0f6ff',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: '14px',
                }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke={i === steps.length - 1 ? '#06b6d4' : '#2563eb'} strokeWidth="1.5">
